...
It is in Weidu format.  To install, unzip the zip file to your game folder and double-click on Setup-LuvNalia.exe.  To uninstall, double-click on Setup-LuvNalia.exe again and select the Uninstall option.
